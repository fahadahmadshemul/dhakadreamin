  ...
  <main id="main">
    ...
    <section id="work" class="work-section reservation-section">
      <div class="container" data-aos="fade-up">
          <form action="{{route('check-out2', $room->id)}}" method="post">
              @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" required name="check_in" id="inputArrival">
                    </div>
                    <div class="form-group">
                        <label for="">Check Out</label>
                        <input type="date" class="form-control" required name="check_out" id="inputCheckout">
                    </div>
                    <div class="form-group">
                        <label for="">Adult</label>
                        <input type="text" class="form-control" required name="adult" id="">
                    </div>
                    <div class="form-group">
                        <label for="">Child</label>
                        <input type="text" class="form-control" required name="child" id="">
                    </div>
                    <div class="form-group">
                        <label for="">Infants</label>
                        <input type="text" class="form-control" required name="infant" id="">
                    </div>
                    <div class="form-group">
                        <br>
