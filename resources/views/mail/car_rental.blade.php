...
<body>
    <h1>Full Day Car Rental  Request </h1>
    <p>Customer Name : {{$customer['name']}}</p>
    <p>Customer Email : {{$customer['email']}}</p>
    <p>Customer Phone : {{$customer['phone']}}</p>
    <form action="" style="max-width:600px;">
        <div>
            <label for="">Inside City</label>
            <input style="display: block;width: 100%;padding: .375rem .75rem;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;background-color: #fff;background-clip: padding-box;border: 1px solid #ced4da;-webkit-appearance: none;-moz-appearance: none;appearance: none;border-radius: .25rem;transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;" type="text" readonly name="" id="" value="{{$details['Inside_City']}}">
        </div>
        <div>
            <label for="">Outside City</label>
            <input style="display: block;width: 100%;padding: .375rem .75rem;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;background-color: #fff;background-clip: padding-box;border: 1px solid #ced4da;-webkit-appearance: none;-moz-appearance: none;appearance: none;border-radius: .25rem;transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;" type="text" readonly name="" id="" value="{{$details['Outside_City']}}">
        </div>
        <div>
